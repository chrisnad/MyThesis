    ...
    use variables, only : dime
     ...
     elseif (typel == 'BEF3') then
        ...
        !----- Tenseur du module d'elasticite des elements massifs
         if(iloi==1 .or. iloi==5 .or. iloi/10==1 .or. iloi/100==1) then                 ! (iloi==1) => isotropie
             select case (dime)
                 case (1)
                     eh=vprel(4)
                     vh=eh
                 ...
                 case (2)
                     ...
                     if(vprel(2)==3) then          ! contraintes planes
                         allocate(vh(3,3))
                         vh(1,:) = eh/(1.d0-cnu*cnu)*(/1.d0, cnu,  0.d0/)
                         vh(2,:) = eh/(1.d0-cnu*cnu)*(/cnu,  1.d0, 0.d0/)
                         vh(3,:) = eh/(1.d0-cnu*cnu)*(/0.d0, 0.d0, .5d0*(1.d0-cnu)/)
...
!---------------------------------------------------------------------------!
   ...
   subroutine elem_info(elem, typelem)
      ...
      select case (typelem)
         ...
         case ('MBQ4')
            ! Element avec point de gauss central a poid null
            elem%nnel = 4
            elem%ndln = 2
            elem%order = 2
         ...
         case ('MTH8')
            ...
            elem%ndln = 3
            elem%order = 1
            call util_quad(elem%Q, elem%W, elem%order, 'HEXAHEDRAL', 3)
...
! Northwestern University
   ...
   select case (typel)
    ...
    case ('MTT4')
        !%%%%%%%%%%%%%%%% T4 FOUR NODE TETRAHEDRAL ELEMENT %%%%%%%%%%%%%%%%%%
        !%
        !%             4
        !%           / | \
        !%          /  |  \
        ...
        !%         -   2  -
            ...
            if (size(coord) < 3) then
                stop 'Error three coordinates needed for the T4 element'
            else
    ...
    case ('MTH8')
        ...
        if (size(coord) < 3) then
            ...
            N = 0.125d0*(/(1.d0+xi*(-1.d0))*(1.d0+eta*(-1.d0))*(1.d0+zeta*(-1.d0)), &
                          (1.d0+xi*(+1.d0))*(1.d0+eta*(-1.d0))*(1.d0+zeta*(-1.d0)), &
                          (1.d0+xi*(+1.d0))*(1.d0+eta*(+1.d0))*(1.d0+zeta*(-1.d0)), &
                          (1.d0+xi*(-1.d0))*(1.d0+eta*(+1.d0))*(1.d0+zeta*(-1.d0)), &
                          (1.d0+xi*(-1.d0))*(1.d0+eta*(-1.d0))*(1.d0+zeta*(+1.d0)), &
                          (1.d0+xi*(+1.d0))*(1.d0+eta*(-1.d0))*(1.d0+zeta*(+1.d0)), &
                          (1.d0+xi*(+1.d0))*(1.d0+eta*(+1.d0))*(1.d0+zeta*(+1.d0)), &
                          (1.d0+xi*(-1.d0))*(1.d0+eta*(+1.d0))*(1.d0+zeta*(+1.d0))/)
            dNdxi(1,:) = 0.125d0*(/(-1.d0)*(1.d0+eta*(-1.d0))*(1.d0+zeta*(-1.d0)), &
                                   (-1.d0)*(1.d0+ xi*(-1.d0))*(1.d0+zeta*(-1.d0)), &
                                   (-1.d0)*(1.d0+ xi*(-1.d0))*(1.d0+ eta*(-1.d0))/)
            dNdxi(2,:) = 0.125d0*(/(+1.d0)*(1.d0+eta*(-1.d0))*(1.d0+zeta*(-1.d0)), &
                                   (-1.d0)*(1.d0+ xi*(+1.d0))*(1.d0+zeta*(-1.d0)), &
                                   (-1.d0)*(1.d0+ xi*(+1.d0))*(1.d0+ eta*(-1.d0))/)
            dNdxi(3,:) = 0.125d0*(/(+1.d0)*(1.d0+eta*(+1.d0))*(1.d0+zeta*(-1.d0)), &
                                   (+1.d0)*(1.d0+ xi*(+1.d0))*(1.d0+zeta*(-1.d0)), &
                                   (-1.d0)*(1.d0+ xi*(+1.d0))*(1.d0+ eta*(+1.d0))/)
            dNdxi(4,:) = 0.125d0*(/(-1.d0)*(1.d0+eta*(+1.d0))*(1.d0+zeta*(-1.d0)), &
                                   (+1.d0)*(1.d0+ xi*(-1.d0))*(1.d0+zeta*(-1.d0)), &
                                   (-1.d0)*(1.d0+ xi*(-1.d0))*(1.d0+ eta*(+1.d0))/)
            dNdxi(5,:) = 0.125d0*(/(-1.d0)*(1.d0+eta*(-1.d0))*(1.d0+zeta*(+1.d0)), &
                                   (-1.d0)*(1.d0+ xi*(-1.d0))*(1.d0+zeta*(+1.d0)), &
                                   (+1.d0)*(1.d0+ xi*(-1.d0))*(1.d0+ eta*(-1.d0))/)
            dNdxi(6,:) = 0.125d0*(/(+1.d0)*(1.d0+eta*(-1.d0))*(1.d0+zeta*(+1.d0)), &
                                   (-1.d0)*(1.d0+ xi*(+1.d0))*(1.d0+zeta*(+1.d0)), &
                                   (+1.d0)*(1.d0+ xi*(+1.d0))*(1.d0+ eta*(-1.d0))/)
            dNdxi(7,:) = 0.125d0*(/(+1.d0)*(1.d0+eta*(+1.d0))*(1.d0+zeta*(+1.d0)), &
                                   (+1.d0)*(1.d0+ xi*(+1.d0))*(1.d0+zeta*(+1.d0)), &
                                   (+1.d0)*(1.d0+ xi*(+1.d0))*(1.d0+ eta*(+1.d0))/)
            dNdxi(8,:) = 0.125d0*(/(-1.d0)*(1.d0+eta*(+1.d0))*(1.d0+zeta*(+1.d0)), &
                                   (+1.d0)*(1.d0+ xi*(-1.d0))*(1.d0+zeta*(+1.d0)), &
                                   (+1.d0)*(1.d0+ xi*(-1.d0))*(1.d0+ eta*(+1.d0))/)
