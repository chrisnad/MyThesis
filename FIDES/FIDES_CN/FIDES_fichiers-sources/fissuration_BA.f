...
!pause
                ...
                kprop(ie) = nbg + ie0
                id = 1
                if (dime==3) id = id+1  !pour faire fonctioner les formules pour le stockage
                !----- Stockage de l'energie BA
                if (nrjbap .or. nrjbap2) then
                    if (iloi==26.or.iloi==27) then  ! Loi orthotrope endommageable
                        do i=1,dime
                            vprelg0(kprop(ie),id+3*dime+(i-1)*3+1) = PBA1(i)
                        end do
                    end if
                end if
                ...
                if (nrjbap2) then
                    if (iloi==26.or.iloi==27) then  ! Loi orthotrope endommageable
                        do i=1,dime
                            vprelg0(kprop(ie),id+3*dime+(i-1)*3+2) = PBA2(i)
                        end do
                    end if
                end if
            end if
