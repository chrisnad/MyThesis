...
!------------------------------------------------------------------------!
   subroutine initva (va, kva, nomcomp)
      ...
      use variables, only : nelt, infele, ktypel, calco
      implicit none
...
!--------------------------------------------------------------------------------!
   ...
   subroutine initint_vec(vec, taille , valeur)
      ...
      allocate(vec(taille))
      if (present(valeur)) then; vec = valeur; else; vec = 0; end if
...
!---------------------------------------------------------------------------------!
   ...
   subroutine initreal8_vec(vec, taille, valeur)
      ...
      if (present(valeur)) then; vec = valeur; else; vec = 0.d0; end if
...
!---------------------------------------------------------------------------------!
   ...
   subroutine initchaine_vec(vec, taille, L, valeur)
      ...
      if (present(valeur)) then; vec = valeur; else; vec = ''; end if
...
!---------------------------------------------------------------------------------!
   ...
   subroutine initlogi_vec(vec, taille, valeur)
      ...
      if (present(valeur)) then; vec = valeur; else; vec = .false.; end if
...
!---------------------------------------------------------------------------------!
   ...
   subroutine initint_mat(mat, nbl, nbc, valeur)
      ...
      if (present(valeur)) then; mat = valeur; else; mat = 0; end if
...
!---------------------------------------------------------------------------------!
   ...
   subroutine initlogi_mat(mat, nbl, nbc, valeur)
      ...
      if (present(valeur)) then; mat = valeur; else; mat = .false.; end if
