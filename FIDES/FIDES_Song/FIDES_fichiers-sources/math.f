...
implicit none 
   ...
   !***************************************************************************!
   !            Divers fonctions et procedure de type mathematique             !
   !***************************************************************************!
...
!------------------------------------------------------------------------------!
   ...
   function randgp(n,seed)
        ...
        integer :: b, i, s, freq, germe(12), values(8) !, germe(12) ! pour gfortran 4.4 et later
...
!---------------------------------------------------------------------------!
!                    fonction unique (avec reordonnement)                   !
!---------------------------------------------------------------------------!
...
!  ***************************************************************
 ...
 integer :: N
 integer, PARAMETER:: NMAX=300,TINY=1.5D-16
 REAL*8 :: AMAX,DUM, SUM
