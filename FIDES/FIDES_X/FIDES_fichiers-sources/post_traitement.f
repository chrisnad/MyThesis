...
!
!> @brief
!> Creation des fichiers de post-traitement utilisables par GID
!
!> @details
!> #### DESCRIPTION:
!>  A faire
!
!> @todo
!> Reecrire cette routine en fortran 90 !!! (suppression des goto et etiquettes correspondantes)
!------------------------------------------------------------------------------------------------------
...
!
!> @brief
!> Calcul de l'ouverture (centrale, maximale, ou moyenne) d'un element d'interface
!
!> @details
!> #### DESCRIPTION:
