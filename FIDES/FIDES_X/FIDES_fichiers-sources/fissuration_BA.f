...
subroutine fissBA_sig_endo_ortho(vsig,vin,vh,vb,vprel,vdle,iloi,ie)
    ...
    real*8 :: sigpa, Ea, eps0, epsc, epsl, vsigx
    ...
    select case(iloi)
        ...
        case(27)
            ...
            Ea    = vprel(id+dime**2+1)          !     |     de
            epsl  = eps0 + vprel(id+dime**2+2)   !     |   la loi
            vsigx = vprel(id+dime**2+3)          !    /

            sigpa = (epsl-eps0)*Ea + vsigx       ! debut de non-linearite du comportement des aciers
            ...
            if(vcrit .eqv. .true.) then
                ...
                elseif (0.d0 <= epsilon1 .and. epsilon1 < epsl) then
                    D0 = 1.d0 - (vsigx/(eps0*E1))
                    Dnul1 = 0.d0
                    Dnul2 = 1.d0
                    ...
                    if (var >= vars) then
                        ...
                        D = 1.d0 - (vsigx+Ea*(var-eps0))/(var*E1)
