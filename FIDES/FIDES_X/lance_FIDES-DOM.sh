...
do
	...
	if  (($j == 1))
	then
                nomfich='3d_DCB_macro_hollow'
                nomdirsauv='3d_DCB_macro_hollow'
        	numdirsup='3D'
		more=0
	fi 
    ...
    mkdir ../../'FIDES_POST_Z'/'FIDES_resultats'/$nomdirsauv/
	#
	# Initialisations
	# ---------------
	echo '-------------------------------------------------'
	...
	do
	   ...
	   mkdir ../../'FIDES_POST_Z'/'FIDES_resultats'/$nomdirsauv/$icompt/
	   cp ../$nomdirstock/$nomfich.reac ../../'FIDES_POST_Z'/'FIDES_resultats'/$nomdirsauv/$icompt/$nomfich.reac
	   mv ../$nomdirstock/$nomfich.list ../../'FIDES_POST_Z'/'FIDES_resultats'/$nomdirsauv/$icompt/$nomfich.list
	   mv ../$nomdirstock/$nomfich.prop ../../'FIDES_POST_Z'/'FIDES_resultats'/$nomdirsauv/$icompt/$nomfich.prop
