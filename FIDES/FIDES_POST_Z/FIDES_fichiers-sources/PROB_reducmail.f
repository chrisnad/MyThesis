...
!
!> @brief
!> Routine de transformation homothetique du maillage (pour etude d'analyse inverse)
!
!> @details
!> #### DESCRIPTION:
!>  A faire
!
!> @todo
!>  Ce fichier doit disparaitre a terme. Cree uniquement pour alimenter le modele de fissuration
!------------------------------------------------------------------------------------------------------
