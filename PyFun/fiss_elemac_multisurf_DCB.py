...
filename = "DCBlocalcheat3"
directory = "/home/christian/Documents/FIDES/FIDES_POST_SONG/FIDES_resultats/" + filename + "/10"
...
#surf = [0.965, 1.065, 1.165, 1.265, 1.365, 1.465, 1.565, 1.665, 1.765]		#macro  +- 0.0016
surf = [0.965, 1.165, 1.365, 1.565, 1.765]									#macro_L  +- 0.0016
#surf = [0.99, 1.04, 1.09, 1.14, 1.19, 1.24, 1.29, 1.34, 1.39, 1.44, 1.49, 1.54, 1.59, 1.64, 1.69, 1.74, 1.79]	#macro_s +- 0.0035
...
for I in surf:
	...
	for i in [j for j in coor if ((coor[j][1] <= I+0.0016) and (coor[j][1] >= I-0.0016))]:		#0.0035 is mesh dependant (margin for the surface ordinate)
