...
os.chdir("/home/christian/Desktop/coupes_tirant-song/sig-eps")
...
for filename in os.listdir(os.getcwd()):
    ...
    os.chdir("/home/christian/Desktop/courbes_model_tirant-song")

    f = open("modele_" + filename, "w")
