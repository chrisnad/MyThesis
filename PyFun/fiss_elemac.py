...
directory = "/home/christian/Documents/FIDES/FIDES_POST_test/FIDES_resultats/poutre_macro_CN_mmdist/1"
os.chdir(directory)

filename = "poutre_macro_CN_mmdist"
...
fao.write("Abscisse  Ouverture_de_fissures  Pas_de_calcul  Ordonne\n")
for i in abs_ouv:
	fao.write('%.17E' % i[0] + "  ")
	fao.write('%.17E' % i[1] + "  ")
	fao.write('%.17E' % i[2] + "\n")
